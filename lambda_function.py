...
from generate_simple_report import create_analytics_report

# def lambda_handler(event, context):
path = "X:\Divyy\generate-analytics-report" # insert your own path here

EMAIL_ADDRESS = "naveenagrwl1969@gmail.com"
EMAIL_PASSWORD = os.environ.get('PY_EMAIL_PASSWORD')

msg = EmailMessage()
msg['Subject'] = 'Covid-19 Analytics Report'
msg['From'] = EMAIL_ADDRESS
msg['To'] = 'divyygarg001@gmail.com'
